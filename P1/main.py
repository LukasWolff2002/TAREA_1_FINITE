...
structure_1 = Structure(dxdy = [0.8, 0.0])
...
plot_deformed_structure(structure_1.elements, text=False, nodes=True, nodes_labels=False, deformada=True, escala=100)

plotStructureWithMomentDiagram(structure_1.elements, escala_momentos=1e-4, show_structure=True)
